...
<Link to='/contact' className="footer-call-to-action-button button" target="_self">
  Get in Touch
</Link>
          </div>
          <div class="footer-call-to-action">
        ...
        <div class="footer-social-links"> <svg class="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a class="footer-social-link linkedin" href="https://www.linkedin.com/in/pranav-kashikey-042a96269/" target="_blank">
          ...
          <a class="footer-social-link github" href="https://github.com/Pranavkashikey" target="_blank">
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self"> ©2020. | Designed By: Pranav & Madhu. | All rights reserved. <img src="./squid game.png" alt="" className="squid"/></a>
          </p>
        </div>
      </div>
    </footer>
